    ...
    <View style={styles.container}>
      <FlatList
        ...
        renderItem={(info: ListRenderItemInfo<User>) => {
          return (
            <View style={{marginHorizontal: 10, marginVertical: 4, borderRadius: 10, padding: 10, backgroundColor: 'white'}}>
              <Text style={{fontWeight: 'bold'}}>Name</Text>
              <Text>{info.item.name}</Text>
              <Text style={{fontWeight: 'bold', marginTop: 10}}>Age</Text>
              <Text>{info.item.age}</Text>
              <Text style={{fontWeight: 'bold', marginTop: 10}}>Favorite Book</Text>
