...
interface ISQLite {
  ...
  executeSql: (dbName: string, query: string, params: any[] | undefined) => {
    rows: any[],
    insertId?: number
  }
...
// let sequelWrapper = {
//   open: (options: {dbName: string}, scb: (res: any) => void, ecb: (res: any) => void) => {
//     try {
//       const result = sequel.open(options.dbName);
//       scb(result)
//     } catch(e) {
//       ecb(e.message)
//     }
//   },
//   executeSql: (options: {dbName: string, sql: string}, scb: (res: any) => void, ecb: (res: any) => void) => {
//     try {
//       const result = sequel.executeSql(options.dbName, options.sql);
//       scb(result)
//     } catch(e) {
//       ecb(e.message)
//     }
//   },
//   backgroundExecuteSql: async (options: { dbName: string, sql: string}, scb: (res: any) => void, ecb: (res: any) => void) => {
//     try {
//       const result = await sequel.executeSql(options.dbName, options.sql);
//       scb(result)
//     } catch(e) {
//       ecb(e.message)
//     }
...
// let READ_ONLY_REGEX = /^(\s|;)*(?:alter|create|delete|drop|insert|reindex|replace|update)/i;

// let DB_STATE_INIT = 'INIT';

// let DB_STATE_OPEN = 'OPEN';

// let txLocks: Record<string, any> = {};

// let newSQLError = function (error: string, code?: number) {
//   var sqlError;
//   sqlError = error;
//   if (!code) {
//     code = 0;
...
// type SequelMethod = 'open' | 'executeSql'

// plugin.exec = function (method: keyof typeof sequel, options: any, success: (res: any) => void, error: (msg: string) => void) {
//   if (plugin.sqlitePlugin.DEBUG) {
//     plugin.log('SQLite.' + method + '(' + JSON.stringify(options) + ')');
//   }

//   sequelWrapper[method](options, success, error);
// };

// plugin.log = function (...messages: any[]) {
//   if (plugin.sqlitePlugin.DEBUG) {
//     console.log(...messages);
//   }
// };

// let SQLitePlugin = function (this: any, openargs: {name: string}, openSuccess: (msg: string) => void, openError: (msg: string) => void) {
//   let dbname: string;
...
//     });
//   this.openError ||
//     (this.openError = function (e: Error) {
...
// SQLitePlugin.prototype.addTransaction = function (t: any) {
...
// SQLitePlugin.prototype.transaction = function (fn: any, error: any, success: any) {
...
// SQLitePlugin.prototype.readTransaction = function (fn: any, error: any, success: any) {
//   if (!this.openDBs[this.dbname]) {
//     error(newSQLError('database not open'));
//     return;
//   }
...
// SQLitePlugin.prototype.startNextTransaction = function (this: any) {
//   let self = this;
//   nextTick(
//     (function (_this) {
//       return function () {
...
// SQLitePlugin.prototype.sqlBatch = function (sqlStatements: string[], success: any, error: any) {
//   // @ts-ignore
...
// SQLitePlugin.prototype.open = function (success: any, error: any) {
...
// SQLitePlugin.prototype.close = function (success: any, error: any) {
//   if (this.dbname in this.openDBs) {
...
//     }
//     let mysuccess = function (t: any, r: string) {
//       if (!!success) {
//         return success(r);
//       }
//     };
//     let myerror = function (t: any, e: string) {
//       if (!!error) {
//         return error(e);
//       } else {
//         plugin.log('Error handler not provided: ', e);
...
// SQLitePlugin.prototype.detach = function (dbAlias: string, success: any, error: any) {
//   if (this.dbname in this.openDBs) {
//     if (txLocks[this.dbname] && txLocks[this.dbname].inProgress) {
//       plugin.log('cannot attach: transaction is in progress');
//       error(
...
//   let mysuccess = function (t: any, r: any) {
//     if (!!success) {
//       return success(r);
//     }
//   };
//   let myerror = function (t: any, e: any) {
//     if (!!error) {
//       return error(e);
//     } else {
//       plugin.log('Error handler not provided: ', e);
...
// let SQLitePluginTransaction: any = function (this: any, db: any, fn: any, error: any, success: any, txlock: any, readOnly: boolean) {
...
//   this.executes = [];
//   if (txlock) {
//     this.addStatement('BEGIN', [], null, function (tx: any, err: any) {
//       throw newSQLError(
...
// export const SQLiteFactory = function () {};
